...
Wet-bulb deviation range & 0.8--1.0$^\circ$C by hour \\
...
\begin{itemize}[leftmargin=1.5em]
    ...
    \item deterministic, partially robust, and ambient-aware robust MILP model builders,
...
In addition to the main-paper figures, the repository exports commitment heatmaps, per-method cooling-balance plots, power-tariff overlays, storage trajectories, and weather-robustness ablation charts. These diagnostics are useful when inspecting how uncertainty budgets alter commitment timing and how ambient-aware robustness changes the use of storage and chiller headroom.
